...
const ProfilePictureContainer = styled.div<Props>`
  width: 110px;
  height: 110px;
  border-radius: 50%;
  border-width: 2.5x;
...
interface AddCompanyImage {
    ...
    setUserHasProfilePicture: any,
    displayCustomiseAvatar?: boolean,
    setDisplayCustomiseAvatar?: any,
    avatarBackgroundColor?: string,
    avatarFontColor?: string,
    disableCustomise?: boolean
    error?: boolean
}
...
function AddCompanyImage({
    ...
    return (
        <InputProfilePictureItem>
            <ProfilePictureContainer error={error}>
